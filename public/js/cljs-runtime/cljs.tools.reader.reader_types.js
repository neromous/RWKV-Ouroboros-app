...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_18182 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_18182(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_18183 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_18183(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18184 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_18184(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18187 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_18187(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18188 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_18188(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18190 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_18190(reader);
}
});
...
var G__18207 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__18208 = s.append(c);
c = G__18207;
s = G__18208;
continue;
}
