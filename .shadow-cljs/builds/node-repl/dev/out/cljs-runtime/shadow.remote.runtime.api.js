...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_10952 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_10952(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_10957 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_10957(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_10968 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_10968(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_10979 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_10979(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_10985 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_10985(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_10999 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_10999(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__10941,callback){
var map__10943 = p__10941;
var map__10943__$1 = cljs.core.__destructure_map(map__10943);
var input = map__10943__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10943__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10943__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
