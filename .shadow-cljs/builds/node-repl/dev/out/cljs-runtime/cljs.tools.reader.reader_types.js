...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11781 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11781(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11786 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11786(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11788 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11788(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11791 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11791(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11794 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11794(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11796 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11796(reader);
}
});
...
var G__11842 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11843 = s.append(c);
c = G__11842;
s = G__11843;
continue;
}
